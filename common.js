...
var cartitem = {};
var counter = 0;
localStorage["cart"] = 0; //cart badge
...
function Qasa20WCart(){
   ...
   document.getElementById('carts').innerHTML =  localStorage["cart"];
    ...
    function QasaDelete(){
      ...
      var Qasa20Wsolarpanel = document.getElementById("Qasa-20W-solar-panel");
     Qasa20Wsolarpanel.style.display ='none';
     localStorage["cart"]--;
     document.getElementById('carts').innerHTML =  localStorage["cart"];
     localStorage['Qasa20WCounter'] = 0;
    };
...
localStorage['SolarCartCounter'] = 0; //solar cart bridge counter
 var Quantityvalue;
...
var SolarRechargeableTableFanQuantity = document.getElementById("Solar-Rechargeable-Table-Fan-Quantity").value;
SolarRechargeableFan.style.display ='block';
 var SolarRechargeableTableFanDelete = document.getElementById("Solar-Rechargeable-Table-Fan-Delete");
...
//Qasa  Power Kit
localStorage['QasaCounter'] = 0; //cart counter
...
function QasaSolarRechargeableDelete(){
  ...
  QasaSolarRechargeablePowerKit.style.display ='none';
...
localStorage['fullqasacouter'] = 0; //cart counter
...
localStorage["solarLampCount"] = 0; //cart counter
  ...
  SolarRechargeableLampValue = Number(SolarRechargeableLampValue);
          ...
          function SolarRechargeableLampCart(){
            ...
            function SolarLampDelete(){
              ...
              SolarRechargeableLamp.style.display ='none';
...
localStorage["solarLedCount"] = 0; //cart counter
...
function SolarRechargeableBulbchangevalue(t){
  ...
  function SolarLedBulbDelete(){
    ...
    SolarRechargeableBulb.style.display = 'none';
...
var cartorder = `<!-- Solar Rechargeable Table fan Cart -->
...
<!--  Qasa Rechargeable Solar Kit Cart -->
...
<!-- Full Qasa Rechargeable Solar Power Kit -->
